<template>
  <div class="bg-[#EDEEB6] flex flex-col items-center justify-start pt-5 px-5 gap-5 h-full pb-15">
      ...
      <div class="flex flex-col items-stretch w-screen flex-none">
...
export default { 
  components: { SmallGameCard, GameCardExpanded },
  ...
  data() {
      return {
          ...
          borrowedGames: [
            {
                id: 1,
                image_url: "https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1600449593257",
                name: "Cluedo",
                min_players: 3,
                max_players: 6,
                min_age: 10,
            ...
            {
                id: 2,
                image_url: "https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1609460299342",
                name: "Monopoly",
                min_players: 2,
                max_players: 5,
                min_age: 8,
                description: "<p>Get a handy way to play the classic property-trading game! Be the first collect 3 full property sets of different colors, and you’ll win the <strong>Monopoly Deal Card Game</strong>.</p>\r\n<p>You’ll pick up cards when it's your turn and play Action cards to charge players rent, steal their cards or demand money for your birthday. Build up property sets, gather piles of money and keep wheeling and dealing until you're the Monopoly Deal winner!</p>"
            },
          ],
          userGames: [
          {
                id: 3,
                image_url: "https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1596731709416",
                name: "Uno",
                min_players: 2,
                max_players: 10,
                min_age: 8,
